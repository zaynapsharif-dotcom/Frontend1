...
export default function RegisterPage() {
  ...
  useEffect(() => {
    // If not passed recently, redirect to /liveness?next=/register&scope=register
    enforceLiveness(router, pathname || "/register", "register");
  }, [router, pathname]);
            ...
            <form onSubmit={sendOtp} className="space-y-6">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-[11px] text-slate-400 font-medium ml-1">
                  Enter exactly 11 digits. Example: 07701234567.
                </p>
              </div>
            ...
            <form onSubmit={verifyAndCreate} className="space-y-5">
              ...
              <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl border border-slate-100">
                <div className="flex items-center gap-2 text-sm text-slate-600">
                  ...
                  <span className="font-mono font-medium">{normalizePhone(phone)}</span>
                </div>
                <button
                  type="button"
                  onClick={() => setStep(1)}
